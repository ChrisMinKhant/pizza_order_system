    ...
    <div class="container-fluid bg-dark mb-30">
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block align-self-center">
                <span class="text-white fs-2 fw-bold">Gin Pizza<i class="fa-solid fa-pizza-slice"></i></span>
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ route('user#cart#list') }}" class="nav-item nav-link">My Cart</a>
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block me-5">
                            <div class="dropdown me-5">
                                <a class="btn btn-dark dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <i class="fa-solid fa-circle-user me-2"></i> <span
                                        class="text-capitalize">{{ Auth::user()->name }}</span>
                                </a>
                                <ul class="dropdown-menu me-5">
                                    <li><a class="dropdown-item my-3" href="{{ route('user#account#editpage') }}"><i
                                                class="fa-solid fa-clipboard-list me-2"></i>Account</a></li>
                                    <li><a class="dropdown-item my-3" href="{{ route('user#password#changepage') }}"><i
                                                class="fa-solid fa-lock me-2"></i>Change Password</a></li>
                                    <li>
                                        <form action="{{ route('logout') }}" method="post"
                                            class="dropdown-item my-3 text-center">
                                            @csrf
                                            <button class="btn btn-primary text-white rounded-2 btn-block"><i
